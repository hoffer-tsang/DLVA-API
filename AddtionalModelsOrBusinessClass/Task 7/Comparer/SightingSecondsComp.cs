...
namespace AddtionalModelsOrBusinessClass.Task_7.Comparer
{
    ...
    /// </summary>
    public class SightingSecondsComp : IComparer<SightingsListDisplay>
    {
        /// <summary>
        /// Sighting Search Make Comparer
        /// </summary>
        ...
        {
            if (x.SecondsAfterRedLight.CompareTo(y.SecondsAfterRedLight) != 0)
            {
            ...
            else if (x.DateIssued.CompareTo(y.DateIssued) != 0)
            {
