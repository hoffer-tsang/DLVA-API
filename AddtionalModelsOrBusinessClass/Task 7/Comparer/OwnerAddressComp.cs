...
namespace AddtionalModelsOrBusinessClass.Task_7.Comparer
{
    ...
    /// </summary>
    public class OwnerAddressComp : IComparer<OwnerSearchDisplayList>
    {
        /// <summary>
        /// Owner Search Owner Comparer
        /// </summary>
        ...
        {
            if (x.AddressLine1.CompareTo(y.AddressLine1) != 0)
            {
            ...
            else if (x.DateOfBirth.CompareTo(y.DateOfBirth) != 0)
            {
